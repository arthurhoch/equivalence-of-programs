...
const generateChainSets = (programa) => {
    ...
    for (var i = lastStopIndex; i >= 0; i--) {
        ...
        // Se a ultima parada possuir somente 1 operacao de parada e nao duas, 
        // verifica somente a primeira operacao de parada das demais linhas para inserir no conjunto
        if (i === lastStopIndex && lineSplited[2] !== '(parada,Σ)') {
            ...
            for (var x = programa.length - 1; x >= 0; x--) {
                ...
                if ((lineSplited[1] === subLineSplited[1])) {
